document.addEventListener("DOMContentLoaded", () => {
    ...
    pages.forEach((page) => {
      page.addEventListener("click", () => {
        ...
        // Aqui você pode adicionar lógica para trocar o conteúdo da galeria dinamicamente se quiser
        console.log("Página selecionada:", page.textContent);
      });
    });
  });
// --- Chatbot e outras funções permanecem abaixo ---
//chatbot
